...
class PrestamoServiceTest extends UtilidadesTest{
    ...
    void obtenerTodosPrestamosTest() {
        ...
        prestamoService.crearPrestamo(
                new Prestamo("PRE002", "LIB-002", "USR002", getFecha("2024-03-01"), getFecha("2024-03-30")));
        prestamoService.crearPrestamo(
                new Prestamo("PRE003", "LIB-003", "USR003", getFecha("2024-02-01"), getFecha("2024-02-28")));
    ...
    void eliminarPrestamoTest() {
        prestamoService.crearPrestamo(
                new Prestamo("PRE006", "LIB-001", "USR001", getFecha("2024-04-15"), getFecha("2024-04-30")));
    ...
    void obtenerPrestamosVencidosTest() {
        prestamoService.crearPrestamo(
                new Prestamo("PRE007", "LIB-007", "USR007", getFecha("2023-01-01"), getFecha("2023-02-01")));
        prestamoService.crearPrestamo(
                new Prestamo("PRE008", "LIB-008", "USR007", getFecha("2024-01-01"), getFecha("2025-01-01")));
    ...
    void obtenerPrestamosPorUsuarioTest() {
        prestamoService.crearPrestamo(
                new Prestamo("PRE009", "LIB-009", "USR008", getFecha("2024-04-01"), getFecha("2024-04-20")));
        prestamoService.crearPrestamo(
                new Prestamo("PRE010", "LIB-010", "USR008", getFecha("2024-04-02"), getFecha("2024-04-25")));
    ...
    void obtenerPrestamosActivosTest() {
        ...
        prestamoService.crearPrestamo(
                new Prestamo("PRE011", "LIB-011", "USR009", getFecha("2024-04-10"), getFecha("2024-04-15")));
        prestamoService
                .crearPrestamo(new Prestamo("PRE012", "LIB-012", "USR009", getFecha("2024-04-20"), futuro.getTime()));
